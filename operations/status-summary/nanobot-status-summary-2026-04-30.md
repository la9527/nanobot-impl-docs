...
- `docs/archive/assistant-direction-a/workplans/05-5-kakao-adapter-minimal-scope-phase1-plan.md`
- `docs/archive/assistant-direction-a/08-shared-action-result-and-failure-shape.md`
