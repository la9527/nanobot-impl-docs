...
- 2026-05-01 기준 read-only, draft, send approval 의 실제 구현/검증 상태는 `docs/planning/todo.md` section 5.3, 5.4 와 `docs/planning/execution-backlog/03-gmail-readonly-draft-phase1.md`, `04-gmail-send-approval-phase1.md` 를 우선 본다.
