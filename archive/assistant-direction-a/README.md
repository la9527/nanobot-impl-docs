...
- 현재 active implementation source of truth 는 `docs/planning/todo.md` section 5 와 `docs/planning/execution-backlog/*.md` 다.
...
- 구현 진행 상태를 확인할 때는 먼저 `docs/planning/todo.md` section 5 와 `docs/planning/execution-backlog/README.md` 를 본다.
