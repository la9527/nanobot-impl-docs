...
- 2026-05-01 기준 구현 및 검증 source of truth 는 `docs/planning/todo.md` section 5.1 과 `docs/planning/execution-backlog/01-owner-aware-control-surface-phase1.md` 다.
