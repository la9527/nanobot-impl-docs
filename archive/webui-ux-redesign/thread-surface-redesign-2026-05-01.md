...
> 용어 메모: 이 문서는 2026-05-01 당시의 UX 판단 기록이라 `thread`, `dashboard`, `Assistant details` 같은 예전 표현을 포함한다. 현재 WebUI 용어 기준은 [docs/guide/10-webui-terminology.md](../../guide/10-webui-terminology.md) 를 따른다.
