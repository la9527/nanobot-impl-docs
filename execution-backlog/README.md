...
현재 우선순위 기준 구현 대상으로 선정한 항목은 아래다.
...
이번 execution backlog 는 `새로운 기능을 많이 벌리기`보다, 이미 확보한 WebUI/continuity/approval 기반 위에 owner-aware product layer 를 순서대로 올리는 데 초점을 둔다.