...
- 이 문서는 개인비서 제품 축을 설명하는 conceptual summary 다.
- active 구현 우선순위와 체크리스트는 `docs/planning/todo.md` 와 `docs/planning/execution-backlog/*.md` 를 기준으로 본다.
...
- `docs/archive/assistant-direction-a/02-single-user-operating-policy.md`
- `docs/archive/assistant-direction-a/04-channel-continuity-and-identity-mapping.md`
- `docs/archive/assistant-direction-a/05-assistant-automation-architecture.md`
...
- `docs/planning/concepts/owner-profile-and-memory-taxonomy.md`
- `docs/planning/concepts/personal-task-state-model.md`
- `docs/planning/concepts/gmail-calendar-domain-contracts.md`
- `docs/planning/concepts/proactive-policy-and-quiet-hours.md`

실행 백로그 문서:

- `docs/planning/execution-backlog/README.md`
- `docs/planning/execution-backlog/01-owner-aware-control-surface-phase1.md`
- `docs/planning/execution-backlog/02-owner-memory-and-task-backbone-phase1.md`
- `docs/planning/execution-backlog/03-gmail-readonly-draft-phase1.md`
- `docs/planning/execution-backlog/04-gmail-send-approval-phase1.md`
- `docs/planning/execution-backlog/05-calendar-read-conflict-create-phase1.md`
- `docs/planning/execution-backlog/06-proactive-briefing-and-quiet-hours-phase1.md`
