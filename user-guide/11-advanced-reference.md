...
이 문서는 `docs/user-guide/` 바깥에 있는 설계 문서, 운영 메모, 회귀 검토 문서를 어떤 상황에서 보면 좋은지 빠르게 연결하기 위한 안내서다.
...
- [observable-reasoning-plan/README.md](../observable-reasoning-plan/README.md)
...
- [calendar-webui-reliability-review/README.md](../calendar-webui-reliability-review/README.md)
...
- [webui-ux-redesign/README.md](../webui-ux-redesign/README.md)
...
- [status-summary/nanobot-status-summary-2026-05-09.md](../status-summary/nanobot-status-summary-2026-05-09.md)
- [status-summary/nanobot-status-summary-2026-05-10.md](../status-summary/nanobot-status-summary-2026-05-10.md)
...
- [upstream-main-sync-2026-05-08/main-sync-summary.md](../upstream-main-sync-2026-05-08/main-sync-summary.md)
...
4. [webui-ux-redesign/README.md](../webui-ux-redesign/README.md)

### reasoning / thinking row 가 궁금할 때

1. [06. 상태, 작업, 메모리 관리](06-status-task-memory.md)
2. [observable-reasoning-plan/README.md](../observable-reasoning-plan/README.md)
3. [status-summary/nanobot-status-summary-2026-05-10.md](../status-summary/nanobot-status-summary-2026-05-10.md)
...
3. [calendar-webui-reliability-review/README.md](../calendar-webui-reliability-review/README.md)

## 참고 메모

- `user-guide` 는 현재 사용자와 운영자 관점의 설명 문서다.
